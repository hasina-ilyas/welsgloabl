...
$catalog = array(
	'01' => array(
		...
		'category'    => __( 'Content Strategy', 'welsglobal' ),
		'price'       => 15,
	...
	'03' => array(
		...
		'category'    => __( 'Social Media', 'welsglobal' ),
		'price'       => 25,
			...
			<div class="mt-7">
				...
				<div class="flex flex-col gap-3 sm:flex-row">
					<div class="inline-flex h-14 w-full items-center justify-between rounded-full border border-slate-300 bg-white px-2 sm:w-36" data-quantity-control>
						...
						<input id="ebook-quantity" class="w-10 border-0 bg-transparent p-0 text-center text-base font-bold text-brand-navy outline-none" type="number" value="1" min="1" max="10" inputmode="numeric" data-quantity-input>
				...
				<div class="mt-3 hidden items-center gap-2 rounded-xl bg-emerald-50 px-4 py-3 text-sm font-semibold text-emerald-800" role="status" data-cart-message>
					...
					<span><?php esc_html_e( 'Added to your cart.', 'welsglobal' ); ?></span>
					<a class="ml-auto underline underline-offset-2" href="<?php echo esc_url( home_url( '/cart/' ) ); ?>"><?php esc_html_e( 'View cart', 'welsglobal' ); ?></a>
				</div>
			</div>
